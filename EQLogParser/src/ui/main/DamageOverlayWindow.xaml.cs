...
namespace EQLogParser
{
  public partial class DamageOverlayWindow
  {
    ...
    private static CombinedStats _stats;
    ...
    private async void UpdateTimerTick(object sender, EventArgs e)
    {
      ...
      CombinedStats damageOverlayStats = null;
      ...
      _lastUpdateTask = Task.Run(() =>
      {
        try
        {
          lock (StatsLock)
          {
            ...
            var update = DamageStatsManager.ComputeOverlayStats(_currentDamageMode, maxRows, _currentSelectedClass);
      ...
      if (damageOverlayStats != null)
      {
        ...
        if (damageOverlayStats != null)
        {
          LoadStats(damageContent.Children, damageOverlayStats);
        }
    ...
    private void CopyClick(object sender, RoutedEventArgs e)
    {
      lock (StatsLock)
      {
          MainActions.AddAndCopyDamageParse(_stats, _stats.StatsList);
      }
    }
