  ...
  internal class LogProcessor : ILogProcessor
  {
    ...
    private void DoPreProcess(string line, double dateTime, bool monitor)
    {
      ...
      else
      {
        ...
        {
          MainWindow.CastProcessor.Add(lineData);
          MainWindow.HealingProcessor.Add(lineData);
          MainWindow.MiscProcessor.Add(lineData);
          MainWindow.DamageProcessor.Add(lineData);
