...
namespace EQLogParser
{
    internal static partial class MainActions
    {
        ...
        private static MainWindow _mainWindow => MainWindow.mw;
        ...
        //nternal static TimeRange GetAllRanges()
        //
        ...
        //
        //
        //nternal static List<Fight> GetFights()
        //
        ...
        internal static async Task CreateBackupAsync()
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                ...
                var source = Environment.ExpandEnvironmentVariables(ConfigUtil.APP_DATA);
